...
bool callback_iter_interno(const char *clave,void *dato,void *extra)
{ 
    if(*(int*)extra < 10 && strcmp(clave,"2") != 0){
        printf("| %s : %i | \n",clave,*(int*)dato);
        (*(int*)extra)++;
        return true;
    }
...
static void prueba_abb_iterador_interno()
{
    ...
    char *clave1 = "1", *clave2 = "2", *clave3 = "3", *clave4 = "4", *clave5 = "5";
    char *clave6 = "6", *clave7 = "7", *clave8 = "8", *clave9 = "9", *clave95 = "95";

    int valor = 1;

    abb_t* abb = abb_crear(strcmp,NULL);

    print_test("Prueba abb insertar clave7", abb_guardar(abb, clave7, &valor));
    print_test("Prueba abb insertar clave1", abb_guardar(abb, clave1, &valor));
    print_test("Prueba abb insertar clave4", abb_guardar(abb, clave4, &valor));
    print_test("Prueba abb insertar clave10", abb_guardar(abb, clave95, &valor));
    print_test("Prueba abb insertar clave9", abb_guardar(abb, clave9, &valor));
    print_test("Prueba abb insertar clave2", abb_guardar(abb, clave2, &valor));
    print_test("Prueba abb insertar clave6", abb_guardar(abb, clave6, &valor));
    print_test("Prueba abb insertar clave8", abb_guardar(abb, clave8, &valor));
    print_test("Prueba abb insertar clave5", abb_guardar(abb, clave5, &valor));
    print_test("Prueba abb insertar clave3", abb_guardar(abb, clave3, &valor));  

    int extra = 0;
    abb_in_order(abb,callback_iter_interno,&extra);
